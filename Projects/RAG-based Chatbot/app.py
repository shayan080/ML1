...
if question:
    ...
    # Call OpenAI API with the new version for streaming and display the response as it comes
    response = []
    result = ""
    for chunk in openai.Completion.create(
        model="gpt-3.5-turbo",  # You can use gpt-4 if you have access
        prompt=prompt[0]["content"],  # Only pass the updated prompt to the model
